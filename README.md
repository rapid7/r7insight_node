...
This client is not backwards-compatible with [Le_Node](https://github.com/rapid7/le_node) and will require you to make some modifications to your implementation.
